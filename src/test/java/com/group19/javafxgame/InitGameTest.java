...
public class InitGameTest {
    ...
    public void testSprite() {
         ...
         * in a texture is created from in like 29.
         * Sword: swordsman.png
         * Shuriken: ninja.png
         * Shield: shieldsman.png
         */
        Texture texture = FXGL.texture("ninja.png");
        assertEquals(texture.getImage(), CharacterFactory.texture.getImage());
    }

    @Test
    public void testMoney() {
        /**
         * To run this test, start the game and select the difficulty associated with the money in line 41.
         * Beginner: 10
         * Intermediate: 5
         * Veteran: 1
         */
