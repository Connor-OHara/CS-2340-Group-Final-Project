...
public class MonsterInteractionComponent extends Component {
    ...
    public void translateLeft() {
        translateLeft(Constants.getDefaultMonsterVelocity());
    }
    ...
    public void translateRight() {
        translateRight(Constants.getDefaultMonsterVelocity());
    }
    ...
    public void translateUp() {
        translateUp(Constants.getDefaultMonsterVelocity());
    }
    public void stopUp() {
        translateUp(0);
    }
    ...
    public void translateDown() {
        translateDown(Constants.getDefaultMonsterVelocity());
    }
